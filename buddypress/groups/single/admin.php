 ...
 * - manage-members
 *   - Added .dir-list to the wrapping .bp-widget
 *   - Replaced markup of the member loops to match members/member-loop.php
 *   - Moved group moderation links into .action each within span.generic-button
 *
 * @package Zeta
...
<?php if ( bp_is_group_admin_screen( 'manage-members' ) ) : ?>
	...
	<div class="bp-widget dir-list">
		...
		<?php while ( bp_members() ) : bp_the_member(); ?>
			...
			<li <?php bp_member_class( array( count( bp_group_admin_ids( false, 'array' ) ) > 1 ? 'has-actions' : '' ) ); ?>>
	...
	<?php if ( bp_group_has_moderators() ) : ?>
		...
		<div class="bp-widget dir-list">
			...
			<?php while ( bp_members() ) : bp_the_member(); ?>
				...
				<li <?php bp_member_class( array( 'has-actions' ) ); ?>>
					<div class="item-avatar">
						<a href="<?php bp_member_permalink(); ?>"><?php bp_member_avatar( array( 'width' => 80, 'height' => 80 ) ); ?></a>
					</div>
					...
					<div class="action">
						<span class="generic-button">
							<a href="<?php bp_group_member_promote_admin_link( array( 'user_id' => bp_get_member_user_id() ) ); ?>" class="confirm mod-promote-to-admin" title="<?php esc_attr_e( 'Promote to Admin', 'buddypress' ); ?>">
								<?php _e( 'Promote to Admin', 'buddypress' ); ?>
							</a>
						</span>
						<span class="generic-button">
	...
	<div class="bp-widget dir-list">
		...
		<?php if ( bp_group_has_members( 'per_page=15&exclude_banned=0' ) ) : ?>
			...
			<?php while ( bp_group_members() ) : bp_group_the_member(); ?>
				...
				<li <?php bp_member_class( array( 'has-actions ', bp_get_group_member_is_banned() ? apply_filters( 'bp_group_member_css_class', 'banned-user' ) : '' ) ); ?>>
					...
					<div class="item">
						<div class="item-title">
							<a href="<?php bp_member_permalink(); ?>">
								<?php bp_member_name(); ?> <?php if ( bp_get_group_member_is_banned() ) _e( '(banned)', 'buddypress' ); ?>
							</a>
						</div>
					</div>
					...
					<div class="action">
						...
						<span class="generic-button">
							<a href="<?php bp_group_member_unban_link(); ?>" class="confirm member-unban" title="<?php esc_attr_e( 'Unban this member', 'buddypress' ); ?>">
								<?php _e( 'Remove Ban', 'buddypress' ); ?>
							</a>
						</span>
						...
						<span class="generic-button">
							<a href="<?php bp_group_member_ban_link(); ?>" class="confirm member-ban" title="<?php esc_attr_e( 'Kick and ban this member', 'buddypress' ); ?>">
								<?php _e( 'Kick &amp; Ban', 'buddypress' ); ?>
							</a>
						</span>
						<span class="generic-button">
							<a href="<?php bp_group_member_promote_mod_link(); ?>" class="confirm member-promote-to-mod" title="<?php esc_attr_e( 'Promote to Mod', 'buddypress' ); ?>">
								<?php _e( 'Promote to Mod', 'buddypress' ); ?>
							</a>
						</span>
						<span class="generic-button">
							<a href="<?php bp_group_member_promote_admin_link(); ?>" class="confirm member-promote-to-admin" title="<?php esc_attr_e( 'Promote to Admin', 'buddypress' ); ?>">
								<?php _e( 'Promote to Admin', 'buddypress' ); ?>
							</a>
						</span>
						...
						<span class="generic-button">
							<a href="<?php bp_group_member_remove_link(); ?>" class="confirm leave-group" title="<?php esc_attr_e( 'Remove this member', 'buddypress' ); ?>">
								<?php _e( 'Remove from group', 'buddypress' ); ?>
							</a>
						</span>
