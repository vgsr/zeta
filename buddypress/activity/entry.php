 ...
 * - Moved the activity comment form *before* the `bp_activity_comments()` call.
 * - Wrapped .ac-reply-cancel link into a span.cancel-reply, added .button class.
 * - Moved wrapped .ac-reply-cancel link to a new .activity-meta div next to .ac-reply-content.
 * - Added rows=1 to the .ac-input textarea
 * - Changed .ac-reply-content submit <input> into submit <button> element
 *
 * @package Zeta
				...
				<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form"<?php bp_activity_comment_form_nojs_display(); ?>>
					...
					<div class="ac-reply-content">
						<div class="ac-textarea">
							...
							?></label>
							<textarea id="ac-input-<?php bp_activity_id(); ?>" class="ac-input bp-suggestions" name="ac_input_<?php bp_activity_id(); ?>" rows="1"></textarea>
						</div>
						<button type="submit" name="ac_form_submit"><span class="screen-reader-text"><?php esc_attr_e( 'Post', 'buddypress' ); ?></span></button>
						<input type="hidden" name="comment_form_id" value="<?php bp_activity_id(); ?>" />
					</div>

					<div class="activity-meta">
						<span class="cancel-reply"><a href="#" class="button ac-reply-cancel"><?php _e( 'Cancel', 'buddypress' ); ?></a></span>
					</div>
